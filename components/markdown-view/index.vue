<template>
  <div class="markdown-view" v-html="markdownContent"></div>
</template>

<script>
import markdownIt from 'markdown-it'
import hljs from 'highlight.js' // https://highlightjs.org/
import markdownExtends from './extends'
...
export default {
  ...
  methods: {
    // markdown转换为html
    mdToHtml(val) {
      this.markdownContent = this.md.render(val)
    },
    init() {
      this.md = markdownIt({
        html: true,
    ...
    highlight(str, lang) {
      ...
      return '<pre><code class="hljs">' + this.md.utils.escapeHtml(str) + '</code></pre>' // 使用额外的默认转义
    }
  }
}
</script>
